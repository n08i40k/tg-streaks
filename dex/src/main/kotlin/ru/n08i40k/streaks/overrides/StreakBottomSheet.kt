...
class StreakBottomSheet : PremiumPreviewBottomSheet {
    ...
    private val streakData: StreakData
    ...
    constructor(
        ...
        this.premiumFeatures.add(
            PremiumPreviewFragment.PremiumFeatureData(
                ...
                t("dex_sheet_feature_how_title"),
                t("dex_sheet_feature_how_subtitle")
            )
        )
        ...
        this.premiumFeatures.add(
            PremiumPreviewFragment.PremiumFeatureData(
                ...
                t("dex_sheet_feature_levels_title"),
                t("dex_sheet_feature_levels_subtitle")
            )
        )
        ...
        this.premiumFeatures.add(
            PremiumPreviewFragment.PremiumFeatureData(
                ...
                t("dex_sheet_feature_keep_title"),
                t("dex_sheet_feature_keep_subtitle")
            )
        )
        ...
        this.premiumFeatures.add(
            PremiumPreviewFragment.PremiumFeatureData(
                ...
                t("dex_sheet_feature_incorrect_title"),
                t("dex_sheet_feature_incorrect_subtitle")
            )
        )
        ...
        this.titleView[1].text =
            AndroidUtilities.replaceTags(
                tf(
                    ...
                    "days" to streakData.length
                )
            )
        this.subtitleView.text =
            AndroidUtilities.replaceTags(t("dex_sheet_subtitle"))
