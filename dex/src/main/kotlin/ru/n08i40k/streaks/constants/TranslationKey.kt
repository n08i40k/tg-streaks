...
object TranslationKey {
    ...
    const val ERR_BACKUP_IMPORT_FAILED = "err.backup_import_failed"
    ...
    const val POPUP_STREAK_STARTED_TITLE = "popup.streak_started.title"
    const val POPUP_STREAK_STARTED_SUBTITLE = "popup.streak_started.subtitle"
    const val POPUP_STREAK_UPGRADED_TITLE = "popup.streak_upgraded.title"
    const val POPUP_STREAK_UPGRADED_SUBTITLE = "popup.streak_upgraded.subtitle"
    const val DB_ERR_NO_BACKUPS_FOUND = "db.err.no_backups_found"
    const val DB_ERR_FAILED_LIST_BACKUPS = "db.err.failed_list_backups"
    const val DB_ERR_FAILED_READ_BACKUP = "db.err.failed_read_backup"
